...
$car1 = new Car (2.4, "Toyota", "1234FGH", "gasoline", "green");
$car2 = new Car (2, "Hyundai", "1433FHH", "oil", "blue");
$car3 = new Car (3, "Mercedes", "1454FFT", "gasoline", "yellow");
$car4 = new Car (4.1, "Opel", "9634QWE", "hybrid", "red");
$car5 = new Car (3.2, "Volkswagen", "3567BVG", "electric", "white");
$car6 = new Car (1.8, "Toyota", "0874GGH", "electric", "grey");
...
$carDealer->echoAllCars($cars);
echo "<br>------------------------------<br>The brands using gasoline are:--------------------------------<br>";
